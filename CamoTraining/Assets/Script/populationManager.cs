...
public class populationManager : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(10, 10, 50, 10), "Generation" + generation, guiStyle);
        GUI.Label(new Rect(10, 65, 50, 10), "Trial Time" + (int)elapsed, guiStyle);
    }
    ...
    void Start()
    {
        ...
        {
            Vector3 pos = new Vector3(Random.Range(-7, 7), Random.Range(-5f, 5f), 0);
            GameObject go = Instantiate(personPrefab, pos, Quaternion.identity);
            go.GetComponent<DNA>().r = Random.Range(0.0f, 1.0f);
            go.GetComponent<DNA>().g = Random.Range(0.0f, 1.0f);
            go.GetComponent<DNA>().b = Random.Range(0.0f, 1.0f);

            go.GetComponent<DNA>().y = Random.Range(0.1f, 0.3f);
